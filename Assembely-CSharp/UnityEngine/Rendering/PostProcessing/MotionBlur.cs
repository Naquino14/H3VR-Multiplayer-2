...
namespace UnityEngine.Rendering.PostProcessing
{
	...
	public sealed class MotionBlur : PostProcessEffectSettings
	{
		...
		{
			return enabled.value && shutterAngle.value > 0f && SystemInfo.supportsMotionVectors && SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.RGHalf) && !RuntimeUtilities.isVREnabled;
		}
	}
}
