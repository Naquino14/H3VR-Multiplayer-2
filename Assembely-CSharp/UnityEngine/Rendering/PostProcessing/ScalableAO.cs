...
namespace UnityEngine.Rendering.PostProcessing
{
	...
	public sealed class ScalableAO : IAmbientOcclusionMethod
	{
		...
		private void Render(PostProcessRenderContext context, CommandBuffer cmd, int occlusionSource)
		{
			...
			cmd.GetTemporaryRT(occlusionTexture, width / num, height / num, 0, FilterMode.Bilinear, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear);
		...
		public void RenderAfterOpaque(PostProcessRenderContext context)
		{
			...
			command.BlitFullscreenTriangle(BuiltinRenderTextureType.None, BuiltinRenderTextureType.CameraTarget, m_PropertySheet, 5);
