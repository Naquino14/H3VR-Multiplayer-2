namespace UnityEngine.Rendering.PostProcessing
{
	public sealed class LogHistogram
	{
		...
		public void Generate(PostProcessRenderContext context)
		{
			...
			command.DispatchCompute(exposureHistogram, kernelIndex, Mathf.CeilToInt(histogramScaleOffsetRes.z / (float)m_ThreadX), Mathf.CeilToInt(histogramScaleOffsetRes.w / (float)m_ThreadY), 1);
