namespace UnityEngine.Rendering.PostProcessing
{
	public sealed class ScreenSpaceReflectionsRenderer : PostProcessEffectRenderer<ScreenSpaceReflections>
	{
		...
		public override void Render(PostProcessRenderContext context)
		{
			...
			propertySheet.properties.SetVector(ShaderIDs.Params, new Vector4(base.settings.attenuation.value, base.settings.distanceFade.value, base.settings.maximumMarchDistance.value, a));
