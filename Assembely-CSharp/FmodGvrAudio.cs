...
public static class FmodGvrAudio
{
	...
	public static void UpdateAudioRoom(FmodGvrAudioRoom room, bool roomEnabled)
	{
		...
		{
			FmodGvrAudioRoom room2 = enabledRooms[enabledRooms.Count - 1];
	...
	{
		RuntimeManager.LowlevelSystem.get3DListenerAttributes(0, out listenerPositionFmod, out VECTOR vel, out vel, out vel);
