...
public class CustomPoolIDSpawn : MonoBehaviour
{
  ...
  public void Spawn()
  {
    ...
    {
      FastPool pool = FastPoolManager.GetPool(1, (GameObject) null, false);
  ...
  {
    for (int index = 0; index < 1000; ++index)
      FastPoolManager.GetPool(1, (GameObject) null, false).FastDestroy(this.hugeObjectsArray[index]);
  }
