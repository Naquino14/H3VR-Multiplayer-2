  ...
  public class AmplifyBloomBase : MonoBehaviour
  {
    ...
    private void OnRenderImage(RenderTexture src, RenderTexture dest)
    {
      ...
      else
      {
        ...
        if (flag1)
          this.ApplyGaussianBlur(renderTexture2, this.m_gaussianSteps[0], this.m_gaussianRadius[0]);
        if (this.m_bloomDownsampleCount > 0)
        {
    ...
    private void FinalComposition(
      ...
      int forcePassId)
    {
      InstaOld component = this.GetComponent<InstaOld>();
      if ((UnityEngine.Object) component != (UnityEngine.Object) null && component.enabled)
      {
        component.BindMaterial(this.m_finalCompositionMaterial);
        this.m_finalCompositionMaterial.EnableKeyword("INSTA_OLD");
      }
      else
        this.m_finalCompositionMaterial.DisableKeyword("INSTA_OLD");
    ...
    public float LensDirtStrength
    {
      ...
      set => this.m_lensDirtStrength = (double) value >= 0.0 ? value : 0.0f;
    }
    ...
    public float LensStarburstStrength
    {
      ...
      set => this.m_lensStarburstStrength = (double) value >= 0.0 ? value : 0.0f;
    }
    ...
    public float BloomRange
    {
      ...
      set => this.m_bloomRange.x = (double) value >= 0.0 ? value : 0.0f;
    }

    public float OverallThreshold
    {
      get => this.m_overallThreshold;
      set => this.m_overallThreshold = (double) value >= 0.0 ? value : 0.0f;
    }
    ...
    public float OverallIntensity
    {
      ...
      set => this.m_bloomParams.x = (double) value >= 0.0 ? value : 0.0f;
    }

    public float BloomScale
    {
      get => this.m_bloomParams.w;
      set => this.m_bloomParams.w = (double) value >= 0.0 ? value : 0.0f;
    }
    ...
    public float FeaturesThreshold
    {
      ...
      set => this.m_featuresThreshold = (double) value >= 0.0 ? value : 0.0f;
    }
