...
namespace FFmpeg.AutoGen
{
  public static class ffmpeg
  {
    ...
    public const uint AV_CODEC_FLAG_CLOSED_GOP = 2147483648;
    ...
    public const uint AV_CODEC_CAP_LOSSLESS = 2147483648;
    ...
    public const uint CODEC_CAP_LOSSLESS = 2147483648;
    ...
    public const ulong AV_NOPTS_VALUE = 9223372036854775808;
    ...
    public const double M_PHI = 1.61803398874989;
    public const double M_PI = 3.14159265358979;
    public const double M_PI_2 = 1.5707963267949;
    ...
    public const uint AV_CPU_FLAG_FORCE = 2147483648;
    ...
    public static extern unsafe AVRational av_codec_get_pkt_timebase(AVCodecContext* avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_codec_set_pkt_timebase(
      AVCodecContext* avctx,
      AVRational val);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecDescriptor* av_codec_get_codec_descriptor(
      AVCodecContext* avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_codec_set_codec_descriptor(
      AVCodecContext* avctx,
      AVCodecDescriptor* desc);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint av_codec_get_codec_properties(AVCodecContext* avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_codec_get_lowres(AVCodecContext* avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_codec_set_lowres(AVCodecContext* avctx, int val);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_codec_get_seek_preroll(AVCodecContext* avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_codec_set_seek_preroll(AVCodecContext* avctx, int val);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe ushort* av_codec_get_chroma_intra_matrix(AVCodecContext* avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_codec_set_chroma_intra_matrix(
      AVCodecContext* avctx,
      ushort* val);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_codec_get_max_lowres(AVCodec* codec);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* av_codec_next(AVCodec* c);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_register(AVCodec* codec);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avcodec_register_all();

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecContext* avcodec_alloc_context3(AVCodec* codec);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_free_context(AVCodecContext** avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_get_context_defaults3(AVCodecContext* s, AVCodec* codec);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClass* avcodec_get_class();

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClass* avcodec_get_frame_class();

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClass* avcodec_get_subtitle_rect_class();

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_copy_context(AVCodecContext* dest, AVCodecContext* src);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_open2(
      AVCodecContext* avctx,
      AVCodec* codec,
      AVDictionary** options);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_close(AVCodecContext* avctx);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avsubtitle_free(AVSubtitle* sub);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPacket* av_packet_alloc();

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPacket* av_packet_clone(AVPacket* src);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_packet_free(AVPacket** pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_init_packet(AVPacket* pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_new_packet(AVPacket* pkt, int size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_shrink_packet(AVPacket* pkt, int size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_grow_packet(AVPacket* pkt, int grow_by);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_from_data(AVPacket* pkt, sbyte* data, int size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dup_packet(AVPacket* pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_copy_packet(AVPacket* dst, AVPacket* src);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_copy_packet_side_data(AVPacket* dst, AVPacket* src);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_free_packet(AVPacket* pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_packet_new_side_data(
      AVPacket* pkt,
      AVPacketSideDataType type,
      int size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_add_side_data(
      AVPacket* pkt,
      AVPacketSideDataType type,
      sbyte* data,
      ulong size);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_shrink_side_data(
      AVPacket* pkt,
      AVPacketSideDataType type,
      int size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_packet_get_side_data(
      AVPacket* pkt,
      AVPacketSideDataType type,
      int* size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_merge_side_data(AVPacket* pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_split_side_data(AVPacket* pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern string av_packet_side_data_name(AVPacketSideDataType type);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_packet_pack_dictionary(AVDictionary* dict, int* size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_unpack_dictionary(
      sbyte* data,
      int size,
      AVDictionary** dict);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_packet_free_side_data(AVPacket* pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_ref(AVPacket* dst, AVPacket* src);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_packet_unref(AVPacket* pkt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_packet_move_ref(AVPacket* dst, AVPacket* src);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_packet_copy_props(AVPacket* dst, AVPacket* src);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_packet_rescale_ts(
      AVPacket* pkt,
      AVRational tb_src,
      AVRational tb_dst);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* avcodec_find_decoder(AVCodecID id);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* avcodec_find_decoder_by_name([MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_default_get_buffer2(
      AVCodecContext* s,
      AVFrame* frame,
      int flags);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_align_dimensions(
      AVCodecContext* s,
      int* width,
      int* height);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_align_dimensions2(
      AVCodecContext* s,
      int* width,
      int* height,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 8)] int[] linesize_align);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_enum_to_chroma_pos(
      int* xpos,
      int* ypos,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_decode_audio4(
      AVCodecContext* avctx,
      AVFrame* frame,
      int* got_frame_ptr,
      AVPacket* avpkt);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_decode_video2(
      AVCodecContext* avctx,
      AVFrame* picture,
      int* got_picture_ptr,
      AVPacket* avpkt);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_decode_subtitle2(
      AVCodecContext* avctx,
      AVSubtitle* sub,
      int* got_sub_ptr,
      AVPacket* avpkt);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecParser* av_parser_next(AVCodecParser* c);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_register_codec_parser(AVCodecParser* parser);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecParserContext* av_parser_init(
      int codec_id);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_parser_parse2(
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_parser_change(
      AVCodecParserContext* s,
      AVCodecContext* avctx,
      sbyte** poutbuf,
      int* poutbuf_size,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_parser_close(AVCodecParserContext* s);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* avcodec_find_encoder(AVCodecID id);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* avcodec_find_encoder_by_name([MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_encode_audio2(
      AVCodecContext* avctx,
      AVPacket* avpkt,
      AVFrame* frame,
      int* got_packet_ptr);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_encode_video2(
      AVCodecContext* avctx,
      AVPacket* avpkt,
      AVFrame* frame,
      int* got_packet_ptr);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_encode_subtitle(
      AVCodecContext* avctx,
      sbyte* buf,
      int buf_size,
      AVSubtitle* sub);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe ReSampleContext* av_audio_resample_init(
      int output_channels,
      int input_channels,
      int output_rate,
      int input_rate,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int audio_resample(
      ReSampleContext* s,
      short* output,
      short* input,
      int nb_samples);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void audio_resample_close(ReSampleContext* s);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVResampleContext* av_resample_init(
      int out_rate,
      int in_rate,
      int filter_length,
      int log2_phase_count,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_resample(
      AVResampleContext* c,
      short* dst,
      short* src,
      int* consumed,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_resample_compensate(
      AVResampleContext* c,
      int sample_delta,
      int compensation_distance);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_resample_close(AVResampleContext* c);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avpicture_alloc(
      AVPicture* picture,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avpicture_free(AVPicture* picture);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avpicture_fill(
      AVPicture* picture,
      sbyte* ptr,
      AVPixelFormat pix_fmt,
      int width,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avpicture_layout(
      AVPicture* src,
      AVPixelFormat pix_fmt,
      int width,
      int height,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_picture_copy(
      AVPicture* dst,
      AVPicture* src,
      AVPixelFormat pix_fmt,
      int width,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_picture_crop(
      AVPicture* dst,
      AVPicture* src,
      AVPixelFormat pix_fmt,
      int top_band,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_picture_pad(
      AVPicture* dst,
      AVPicture* src,
      int height,
      int width,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_get_chroma_sub_sample(
      AVPixelFormat pix_fmt,
      int* h_shift,
      int* v_shift);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_get_pix_fmt_loss(
      AVPixelFormat dst_pix_fmt,
      AVPixelFormat src_pix_fmt,
      int has_alpha);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixelFormat avcodec_find_best_pix_fmt_of_list(
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixelFormat avcodec_find_best_pix_fmt_of_2(
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixelFormat avcodec_find_best_pix_fmt2(
      AVPixelFormat dst_pix_fmt1,
      AVPixelFormat dst_pix_fmt2,
      AVPixelFormat src_pix_fmt,
      int has_alpha,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixelFormat avcodec_default_get_format(
      AVCodecContext* s,
      AVPixelFormat* fmt);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_set_dimensions(
      AVCodecContext* s,
      int width,
      int height);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_string(
      IntPtr buf,
      int buf_size,
      AVCodecContext* enc,
      int encode);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe string av_get_profile_name(AVCodec* codec, int profile);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern string avcodec_profile_name(AVCodecID codec_id, int profile);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_default_execute(
      AVCodecContext* c,
      IntPtr* func,
      void* arg,
      int* ret,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_default_execute2(
      AVCodecContext* c,
      IntPtr* func,
      void* arg,
      int* ret,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_fill_audio_frame(
      AVFrame* frame,
      int nb_channels,
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avcodec_flush_buffers(AVCodecContext* avctx);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_get_audio_frame_duration(
      AVCodecContext* avctx,
      int frame_bytes);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_register_bitstream_filter(AVBitStreamFilter* bsf);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBitStreamFilterContext* av_bitstream_filter_init(
      [MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_bitstream_filter_filter(
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_bitstream_filter_close(AVBitStreamFilterContext* bsf);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBitStreamFilter* av_bitstream_filter_next(
      AVBitStreamFilter* f);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fast_padded_malloc(void* ptr, uint* size, ulong min_size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fast_padded_mallocz(void* ptr, uint* size, ulong min_size);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint av_xiphlacing(sbyte* s, uint v);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_log_missing_feature(
      void* avc,
      [MarshalAs(UnmanagedType.LPStr)] string feature,
      int want_sample);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_log_ask_for_sample(void* avc, [MarshalAs(UnmanagedType.LPStr)] string msg);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_register_hwaccel(AVHWAccel* hwaccel);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVHWAccel* av_hwaccel_next(AVHWAccel* hwaccel);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_lockmgr_register(IntPtr* cb);
    ...
    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avcodec_is_open(AVCodecContext* s);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_codec_is_encoder(AVCodec* codec);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_codec_is_decoder(AVCodec* codec);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecDescriptor* avcodec_descriptor_get(
      AVCodecID id);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecDescriptor* avcodec_descriptor_next(
      AVCodecDescriptor* prev);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecDescriptor* avcodec_descriptor_get_by_name(
      [MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avcodec-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCPBProperties* av_cpb_properties_alloc(ulong* size);
    ...
    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVInputFormat* av_input_audio_device_next(
      AVInputFormat* d);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVInputFormat* av_input_video_device_next(
      AVInputFormat* d);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOutputFormat* av_output_audio_device_next(
      AVOutputFormat* d);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOutputFormat* av_output_video_device_next(
      AVOutputFormat* d);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avdevice_app_to_dev_control_message(
      AVFormatContext* s,
    ...
    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avdevice_dev_to_app_control_message(
      AVFormatContext* s,
    ...
    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avdevice_capabilities_create(
      AVDeviceCapabilitiesQuery** caps,
      AVFormatContext* s,
      AVDictionary** device_options);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avdevice_capabilities_free(
      AVDeviceCapabilitiesQuery** caps,
      AVFormatContext* s);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avdevice_list_devices(
      AVFormatContext* s,
      AVDeviceInfoList** device_list);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avdevice_free_list_devices(AVDeviceInfoList** device_list);

    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avdevice_list_input_sources(
    ...
    [DllImport("avdevice-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avdevice_list_output_sinks(
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_pad_count(AVFilterPad* pads);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe string avfilter_pad_get_name(AVFilterPad* pads, int pad_idx);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVMediaType avfilter_pad_get_type(
      AVFilterPad* pads,
      int pad_idx);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_link(
      AVFilterContext* src,
      uint srcpad,
      AVFilterContext* dst,
      uint dstpad);
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avfilter_link_free(AVFilterLink** link);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_link_get_channels(AVFilterLink* link);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avfilter_link_set_closed(AVFilterLink* link, int closed);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_config_links(AVFilterContext* filter);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_process_command(
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_register(AVFilter* filter);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFilter* avfilter_get_by_name([MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFilter* avfilter_next(AVFilter* prev);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFilter** av_filter_next(AVFilter** filter);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_open(
      AVFilterContext** filter_ctx,
      AVFilter* filter,
      [MarshalAs(UnmanagedType.LPStr)] string inst_name);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_init_filter(
      AVFilterContext* filter,
      [MarshalAs(UnmanagedType.LPStr)] string args,
      void* opaque);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_init_str(AVFilterContext* ctx, [MarshalAs(UnmanagedType.LPStr)] string args);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_init_dict(AVFilterContext* ctx, AVDictionary** options);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avfilter_free(AVFilterContext* filter);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_insert_filter(
      AVFilterLink* link,
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClass* avfilter_get_class();

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFilterGraph* avfilter_graph_alloc();

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFilterContext* avfilter_graph_alloc_filter(
      AVFilterGraph* graph,
      AVFilter* filter,
      [MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFilterContext* avfilter_graph_get_filter(
      AVFilterGraph* graph,
      [MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_add_filter(
      AVFilterGraph* graphctx,
      AVFilterContext* filter);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_create_filter(
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avfilter_graph_set_auto_convert(
      AVFilterGraph* graph,
      uint flags);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_config(AVFilterGraph* graphctx, void* log_ctx);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avfilter_graph_free(AVFilterGraph** graph);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFilterInOut* avfilter_inout_alloc();

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avfilter_inout_free(AVFilterInOut** inout);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_parse(
      AVFilterGraph* graph,
      [MarshalAs(UnmanagedType.LPStr)] string filters,
      AVFilterInOut* inputs,
      AVFilterInOut* outputs,
      void* log_ctx);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_parse_ptr(
      AVFilterGraph* graph,
      [MarshalAs(UnmanagedType.LPStr)] string filters,
      AVFilterInOut** inputs,
      AVFilterInOut** outputs,
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_parse2(
      AVFilterGraph* graph,
      [MarshalAs(UnmanagedType.LPStr)] string filters,
      AVFilterInOut** inputs,
      AVFilterInOut** outputs);
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_send_command(
      AVFilterGraph* graph,
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_queue_command(
      AVFilterGraph* graph,
      [MarshalAs(UnmanagedType.LPStr)] string target,
      [MarshalAs(UnmanagedType.LPStr)] string cmd,
      [MarshalAs(UnmanagedType.LPStr)] string arg,
    ...
    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* avfilter_graph_dump(AVFilterGraph* graph, [MarshalAs(UnmanagedType.LPStr)] string options);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avfilter_graph_request_oldest(AVFilterGraph* graph);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint av_buffersrc_get_nb_failed_requests(AVFilterContext* buffer_src);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffersrc_write_frame(AVFilterContext* ctx, AVFrame* frame);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffersrc_add_frame(AVFilterContext* ctx, AVFrame* frame);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffersrc_add_frame_flags(
      AVFilterContext* buffer_src,
      AVFrame* frame,
      int flags);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffersink_get_frame_flags(
      AVFilterContext* ctx,
      AVFrame* frame,
      int flags);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferSinkParams* av_buffersink_params_alloc();

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVABufferSinkParams* av_abuffersink_params_alloc();

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_buffersink_set_frame_size(
      AVFilterContext* ctx,
      uint frame_size);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVRational av_buffersink_get_frame_rate(
      AVFilterContext* ctx);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffersink_get_frame(AVFilterContext* ctx, AVFrame* frame);

    [DllImport("avfilter-6", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffersink_get_samples(
      AVFilterContext* ctx,
      AVFrame* frame,
      int nb_samples);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_open_dir(
      AVIODirContext** s,
      [MarshalAs(UnmanagedType.LPStr)] string url,
      AVDictionary** options);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_read_dir(AVIODirContext* s, AVIODirEntry** next);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_close_dir(AVIODirContext** s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_free_directory_entry(AVIODirEntry** entry);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVIOContext* avio_alloc_context(
      sbyte* buffer,
      int buffer_size,
      int write_flag,
      void* opaque,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_w8(AVIOContext* s, int b);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_write(AVIOContext* s, sbyte* buf, int size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wl64(AVIOContext* s, ulong val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wb64(AVIOContext* s, ulong val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wl32(AVIOContext* s, uint val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wb32(AVIOContext* s, uint val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wl24(AVIOContext* s, uint val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wb24(AVIOContext* s, uint val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wl16(AVIOContext* s, uint val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_wb16(AVIOContext* s, uint val);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_put_str(AVIOContext* s, [MarshalAs(UnmanagedType.LPStr)] string str);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_put_str16le(AVIOContext* s, [MarshalAs(UnmanagedType.LPStr)] string str);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_put_str16be(AVIOContext* s, [MarshalAs(UnmanagedType.LPStr)] string str);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long avio_seek(AVIOContext* s, long offset, int whence);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long avio_skip(AVIOContext* s, long offset);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long avio_size(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_feof(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int url_feof(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_printf(AVIOContext* s, [MarshalAs(UnmanagedType.LPStr)] string fmt);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avio_flush(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_read(AVIOContext* s, sbyte* buf, int size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_r8(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint avio_rl16(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint avio_rl24(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint avio_rl32(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe ulong avio_rl64(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint avio_rb16(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint avio_rb24(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint avio_rb32(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe ulong avio_rb64(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_get_str(
      AVIOContext* pb,
      int maxlen,
      IntPtr buf,
      int buflen);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_get_str16le(
      AVIOContext* pb,
      int maxlen,
      IntPtr buf,
      int buflen);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_get_str16be(
      AVIOContext* pb,
      int maxlen,
      IntPtr buf,
      int buflen);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_open(AVIOContext** s, [MarshalAs(UnmanagedType.LPStr)] string url, int flags);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_open2(
      AVIOContext** s,
      [MarshalAs(UnmanagedType.LPStr)] string url,
      int flags,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_close(AVIOContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_closep(AVIOContext** s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_open_dyn_buf(AVIOContext** s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_close_dyn_buf(AVIOContext* s, sbyte** pbuffer);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe string avio_enum_protocols(void** opaque, int output);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_pause(AVIOContext* h, int pause);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long avio_seek_time(
      AVIOContext* h,
      int stream_index,
      long timestamp,
      int flags);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_read_to_bprint(
      AVIOContext* h,
      AVBPrint* pb,
      ulong max_size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_accept(AVIOContext* s, AVIOContext** c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avio_handshake(AVIOContext* c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_get_packet(AVIOContext* s, AVPacket* pkt, int size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_append_packet(AVIOContext* s, AVPacket* pkt, int size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVRational av_stream_get_r_frame_rate(AVStream* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_stream_set_r_frame_rate(AVStream* s, AVRational r);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecParserContext* av_stream_get_parser(
      AVStream* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_stream_get_recommended_encoder_configuration(AVStream* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_stream_set_recommended_encoder_configuration(
      AVStream* s,
      IntPtr configuration);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long av_stream_get_end_pts(AVStream* st);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_format_get_probe_score(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* av_format_get_video_codec(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_video_codec(AVFormatContext* s, AVCodec* c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* av_format_get_audio_codec(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_audio_codec(AVFormatContext* s, AVCodec* c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* av_format_get_subtitle_codec(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_subtitle_codec(AVFormatContext* s, AVCodec* c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodec* av_format_get_data_codec(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_data_codec(AVFormatContext* s, AVCodec* c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_format_get_metadata_header_padding(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_metadata_header_padding(
      AVFormatContext* s,
      int c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_format_get_opaque(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_opaque(AVFormatContext* s, void* opaque);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe av_format_control_message av_format_get_control_message_cb(
      AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_control_message_cb(
      AVFormatContext* s,
      av_format_control_message callback);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOpenCallback av_format_get_open_cb(
      AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_set_open_cb(
      AVFormatContext* s,
      AVOpenCallback callback);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_format_inject_global_side_data(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVDurationEstimationMethod av_fmt_ctx_get_duration_estimation_method(
      AVFormatContext* ctx);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_register_input_format(AVInputFormat* format);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_register_output_format(AVOutputFormat* format);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVInputFormat* av_iformat_next(AVInputFormat* f);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOutputFormat* av_oformat_next(AVOutputFormat* f);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFormatContext* avformat_alloc_context();

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avformat_free_context(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClass* avformat_get_class();

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVStream* avformat_new_stream(
      AVFormatContext* s,
      AVCodec* c);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_stream_new_side_data(
      AVStream* stream,
      AVPacketSideDataType type,
      int size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_stream_get_side_data(
      AVStream* stream,
      AVPacketSideDataType type,
      int* size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVProgram* av_new_program(AVFormatContext* s, int id);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_alloc_output_context2(
      AVFormatContext** ctx,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVInputFormat* av_find_input_format([MarshalAs(UnmanagedType.LPStr)] string short_name);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVInputFormat* av_probe_input_format(
      AVProbeData* pd,
      int is_opened);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVInputFormat* av_probe_input_format2(
      AVProbeData* pd,
      int is_opened,
      int* score_max);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVInputFormat* av_probe_input_format3(
      AVProbeData* pd,
      int is_opened,
      int* score_ret);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_probe_input_buffer2(
      AVIOContext* pb,
      AVInputFormat** fmt,
      [MarshalAs(UnmanagedType.LPStr)] string url,
      void* logctx,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_probe_input_buffer(
      AVIOContext* pb,
      AVInputFormat** fmt,
      [MarshalAs(UnmanagedType.LPStr)] string url,
      void* logctx,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_open_input(
      AVFormatContext** ps,
      [MarshalAs(UnmanagedType.LPStr)] string url,
      AVInputFormat* fmt,
      AVDictionary** options);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_demuxer_open(AVFormatContext* ic);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_find_stream_info(
      AVFormatContext* ic,
      AVDictionary** options);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVProgram* av_find_program_from_stream(
      AVFormatContext* ic,
      AVProgram* last,
      int s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_program_add_stream_index(
      AVFormatContext* ac,
      int progid,
      uint idx);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_find_best_stream(
      AVFormatContext* ic,
      AVMediaType type,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_read_frame(AVFormatContext* s, AVPacket* pkt);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_seek_frame(
      AVFormatContext* s,
      int stream_index,
      long timestamp,
      int flags);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_seek_file(
      AVFormatContext* s,
      int stream_index,
      long min_ts,
      long ts,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_flush(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_read_play(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_read_pause(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void avformat_close_input(AVFormatContext** s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_write_header(
      AVFormatContext* s,
      AVDictionary** options);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_write_frame(AVFormatContext* s, AVPacket* pkt);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_interleaved_write_frame(AVFormatContext* s, AVPacket* pkt);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_write_uncoded_frame(
      AVFormatContext* s,
      int stream_index,
      AVFrame* frame);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_interleaved_write_uncoded_frame(
      AVFormatContext* s,
      int stream_index,
      AVFrame* frame);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_write_uncoded_frame_query(
      AVFormatContext* s,
      int stream_index);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_write_trailer(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOutputFormat* av_guess_format(
      [MarshalAs(UnmanagedType.LPStr)] string short_name,
      [MarshalAs(UnmanagedType.LPStr)] string filename,
      [MarshalAs(UnmanagedType.LPStr)] string mime_type);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecID av_guess_codec(
      AVOutputFormat* fmt,
      [MarshalAs(UnmanagedType.LPStr)] string short_name,
      [MarshalAs(UnmanagedType.LPStr)] string filename,
      [MarshalAs(UnmanagedType.LPStr)] string mime_type,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_get_output_timestamp(
      AVFormatContext* s,
      int stream,
      long* dts,
      long* wall);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_hex_dump(_iobuf* f, sbyte* buf, int size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_hex_dump_log(void* avcl, int level, sbyte* buf, int size);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_pkt_dump2(
      _iobuf* f,
      AVPacket* pkt,
      int dump_payload,
      AVStream* st);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_pkt_dump_log2(
      void* avcl,
      int level,
      AVPacket* pkt,
      int dump_payload,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecID av_codec_get_id(AVCodecTag** tags, uint tag);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint av_codec_get_tag(AVCodecTag** tags, AVCodecID id);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_codec_get_tag2(AVCodecTag** tags, AVCodecID id, uint* tag);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_find_default_stream_index(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_index_search_timestamp(
      AVStream* st,
      long timestamp,
      int flags);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_add_index_entry(
      AVStream* st,
      long pos,
      long timestamp,
      int size,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_url_split(
      IntPtr proto,
      int proto_size,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_dump_format(
      AVFormatContext* ic,
      int index,
      [MarshalAs(UnmanagedType.LPStr)] string url,
      int is_output);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_frame_filename(
      IntPtr buf,
      int buf_size,
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_sdp_create(
      AVFormatContext** ac,
      int n_files,
      IntPtr buf,
      int size);
    ...
    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_query_codec(
      AVOutputFormat* ofmt,
      AVCodecID codec_id,
      int std_compliance);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecTag* avformat_get_riff_video_tags();

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecTag* avformat_get_riff_audio_tags();

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecTag* avformat_get_mov_video_tags();

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVCodecTag* avformat_get_mov_audio_tags();

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVRational av_guess_sample_aspect_ratio(
      AVFormatContext* format,
      AVStream* stream,
      AVFrame* frame);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVRational av_guess_frame_rate(
      AVFormatContext* ctx,
      AVStream* stream,
      AVFrame* frame);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_match_stream_specifier(
      AVFormatContext* s,
      AVStream* st,
      [MarshalAs(UnmanagedType.LPStr)] string spec);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int avformat_queue_attached_pictures(AVFormatContext* s);

    [DllImport("avformat-57", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_apply_bitstream_filters(
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_malloc(ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_realloc(void* ptr, ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_realloc_f(void* ptr, ulong nelem, ulong elsize);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_reallocp(void* ptr, ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_realloc_array(void* ptr, ulong nmemb, ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_reallocp_array(void* ptr, ulong nmemb, ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_free(void* ptr);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_mallocz(ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_calloc(ulong nmemb, ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_strdup([MarshalAs(UnmanagedType.LPStr)] string s);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_strndup([MarshalAs(UnmanagedType.LPStr)] string s, ulong len);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_memdup(void* p, ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_freep(void* ptr);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_dynarray_add(void* tab_ptr, int* nb_ptr, void* elem);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dynarray_add_nofree(void* tab_ptr, int* nb_ptr, void* elem);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_dynarray2_add(
      void** tab_ptr,
      int* nb_ptr,
      ulong elem_size,
      sbyte* elem_data);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_memcpy_backptr(sbyte* dst, int back, int cnt);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_fast_realloc(void* ptr, uint* size, ulong min_size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fast_malloc(void* ptr, uint* size, ulong min_size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fast_mallocz(void* ptr, uint* size, ulong min_size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_reduce(
      int* dst_num,
      int* dst_den,
      long num,
      long den,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_find_nearest_q_idx(AVRational q, AVRational* q_list);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long av_rescale_delta(
      AVRational in_tb,
      long in_ts,
      AVRational fs_tb,
      int duration,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_log(void* avcl, int level, [MarshalAs(UnmanagedType.LPStr)] string fmt);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_vlog(void* avcl, int level, [MarshalAs(UnmanagedType.LPStr)] string fmt, sbyte* vl);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_log_set_callback(IntPtr* callback);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_log_default_callback(
      void* avcl,
      int level,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe string av_default_item_name(void* ctx);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClassCategory av_default_get_category(void* ptr);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_log_format_line(
      void* ptr,
      int level,
      [MarshalAs(UnmanagedType.LPStr)] string fmt,
      sbyte* vl,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe uint av_int_list_length_for_size(
      uint elsize,
      void* list,
      ulong term);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe _iobuf* av_fopen_utf8([MarshalAs(UnmanagedType.LPStr)] string path, [MarshalAs(UnmanagedType.LPStr)] string mode);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern AVRational av_get_time_base_q();

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFifoBuffer* av_fifo_alloc(uint size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFifoBuffer* av_fifo_alloc_array(
      ulong nmemb,
      ulong size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fifo_free(AVFifoBuffer* f);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fifo_freep(AVFifoBuffer** f);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fifo_reset(AVFifoBuffer* f);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_size(AVFifoBuffer* f);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_space(AVFifoBuffer* f);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_generic_peek_at(
      AVFifoBuffer* f,
      void* dest,
      int offset,
      int buf_size,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_generic_peek(
      AVFifoBuffer* f,
      void* dest,
      int buf_size,
      IntPtr* func);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_generic_read(
      AVFifoBuffer* f,
      void* dest,
      int buf_size,
      IntPtr* func);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_generic_write(
      AVFifoBuffer* f,
      void* src,
      int size,
      IntPtr* func);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_realloc2(AVFifoBuffer* f, uint size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_fifo_grow(AVFifoBuffer* f, uint additional_space);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_fifo_drain(AVFifoBuffer* f, int size);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_get_sample_fmt_string(
      IntPtr buf,
      int buf_size,
      AVSampleFormat sample_fmt);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_samples_get_buffer_size(
      int* linesize,
      int nb_channels,
      int nb_samples,
      AVSampleFormat sample_fmt,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_samples_fill_arrays(
      sbyte** audio_data,
      int* linesize,
      sbyte* buf,
      int nb_channels,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_samples_alloc(
      sbyte** audio_data,
      int* linesize,
      int nb_channels,
      int nb_samples,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_samples_alloc_array_and_samples(
      sbyte*** audio_data,
      int* linesize,
      int nb_channels,
      int nb_samples,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_samples_copy(
      sbyte** dst,
      sbyte** src,
      int dst_offset,
      int src_offset,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_samples_set_silence(
      sbyte** audio_data,
      int offset,
      int nb_samples,
      int nb_channels,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_audio_fifo_free(AVAudioFifo* af);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVAudioFifo* av_audio_fifo_alloc(
      AVSampleFormat sample_fmt,
      int channels,
      int nb_samples);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_audio_fifo_realloc(AVAudioFifo* af, int nb_samples);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_audio_fifo_write(
      AVAudioFifo* af,
      void** data,
      int nb_samples);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_audio_fifo_peek(
      AVAudioFifo* af,
      void** data,
      int nb_samples);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_audio_fifo_read(
      AVAudioFifo* af,
      void** data,
      int nb_samples);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_audio_fifo_drain(AVAudioFifo* af, int nb_samples);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_audio_fifo_reset(AVAudioFifo* af);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_audio_fifo_size(AVAudioFifo* af);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_audio_fifo_space(AVAudioFifo* af);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_bprint_channel_layout(
      AVBPrint* bp,
      int nb_channels,
      ulong channel_layout);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_get_standard_channel_layout(
      uint index,
      ulong* layout,
      sbyte** name);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_parse_cpu_caps(uint* flags, [MarshalAs(UnmanagedType.LPStr)] string s);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_cpu_count();

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferRef* av_buffer_alloc(int size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferRef* av_buffer_allocz(int size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferRef* av_buffer_create(
      sbyte* data,
      int size,
      IntPtr* free,
      void* opaque,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_buffer_default_free(void* opaque, sbyte* data);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferRef* av_buffer_ref(AVBufferRef* buf);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_buffer_unref(AVBufferRef** buf);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffer_is_writable(AVBufferRef* buf);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_buffer_get_opaque(AVBufferRef* buf);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffer_get_ref_count(AVBufferRef* buf);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffer_make_writable(AVBufferRef** buf);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_buffer_realloc(AVBufferRef** buf, int size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferPool* av_buffer_pool_init(
      int size,
      IntPtr* alloc);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_buffer_pool_uninit(AVBufferPool** pool);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferRef* av_buffer_pool_get(AVBufferPool* pool);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVDictionaryEntry* av_dict_get(
      AVDictionary* m,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dict_count(AVDictionary* m);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dict_set(
      AVDictionary** pm,
      [MarshalAs(UnmanagedType.LPStr)] string key,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dict_set_int(
      AVDictionary** pm,
      [MarshalAs(UnmanagedType.LPStr)] string key,
      long value,
      int flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dict_parse_string(
      AVDictionary** pm,
      [MarshalAs(UnmanagedType.LPStr)] string str,
      [MarshalAs(UnmanagedType.LPStr)] string key_val_sep,
      [MarshalAs(UnmanagedType.LPStr)] string pairs_sep,
      int flags);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dict_copy(AVDictionary** dst, AVDictionary* src, int flags);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_dict_free(AVDictionary** m);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_dict_get_string(
      AVDictionary* m,
      sbyte** buffer,
      sbyte key_val_sep,
      sbyte pairs_sep);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long av_frame_get_best_effort_timestamp(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_best_effort_timestamp(AVFrame* frame, long val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long av_frame_get_pkt_duration(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_pkt_duration(AVFrame* frame, long val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long av_frame_get_pkt_pos(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_pkt_pos(AVFrame* frame, long val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long av_frame_get_channel_layout(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_channel_layout(AVFrame* frame, long val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_get_channels(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_channels(AVFrame* frame, int val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_get_sample_rate(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_sample_rate(AVFrame* frame, int val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVDictionary* av_frame_get_metadata(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_metadata(AVFrame* frame, AVDictionary* val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_get_decode_error_flags(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_decode_error_flags(AVFrame* frame, int val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_get_pkt_size(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_pkt_size(AVFrame* frame, int val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVDictionary** avpriv_frame_get_metadatap(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_frame_get_qp_table(AVFrame* f, int* stride, int* type);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_set_qp_table(
      AVFrame* f,
      AVBufferRef* buf,
      int stride,
      int type);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVColorSpace av_frame_get_colorspace(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_colorspace(AVFrame* frame, AVColorSpace val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVColorRange av_frame_get_color_range(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_set_color_range(AVFrame* frame, AVColorRange val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern string av_get_colorspace_name(AVColorSpace val);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFrame* av_frame_alloc();

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_free(AVFrame** frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_ref(AVFrame* dst, AVFrame* src);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFrame* av_frame_clone(AVFrame* src);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_unref(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_move_ref(AVFrame* dst, AVFrame* src);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_get_buffer(AVFrame* frame, int align);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_is_writable(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_make_writable(AVFrame* frame);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_copy(AVFrame* dst, AVFrame* src);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_frame_copy_props(AVFrame* dst, AVFrame* src);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVBufferRef* av_frame_get_plane_buffer(
      AVFrame* frame,
      int plane);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFrameSideData* av_frame_new_side_data(
      AVFrame* frame,
      AVFrameSideDataType type,
      int size);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVFrameSideData* av_frame_get_side_data(
      AVFrame* frame,
      AVFrameSideDataType type);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_frame_remove_side_data(
      AVFrame* frame,
      AVFrameSideDataType type);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_show2(
      void* obj,
      void* av_log_obj,
      int req_flags,
      int rej_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_opt_set_defaults(void* s);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_opt_set_defaults2(void* s, int mask, int flags);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_set_options_string(
      void* ctx,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_from_string(
      void* ctx,
      [MarshalAs(UnmanagedType.LPStr)] string opts,
      string[] shorthand,
      [MarshalAs(UnmanagedType.LPStr)] string key_val_sep,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_opt_free(void* obj);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_flag_is_set(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string field_name,
      [MarshalAs(UnmanagedType.LPStr)] string flag_name);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_dict(void* obj, AVDictionary** options);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_dict2(
      void* obj,
      AVDictionary** options,
      int search_flags);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_key_value(
      sbyte** ropts,
      [MarshalAs(UnmanagedType.LPStr)] string key_val_sep,
      [MarshalAs(UnmanagedType.LPStr)] string pairs_sep,
      uint flags,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_eval_flags(
      void* obj,
      AVOption* o,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_eval_int(
      void* obj,
      AVOption* o,
      [MarshalAs(UnmanagedType.LPStr)] string val,
      int* int_out);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_eval_int64(
      void* obj,
      AVOption* o,
      [MarshalAs(UnmanagedType.LPStr)] string val,
      long* int64_out);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_eval_float(
      void* obj,
      AVOption* o,
      [MarshalAs(UnmanagedType.LPStr)] string val,
      float* float_out);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_eval_double(
      void* obj,
      AVOption* o,
      [MarshalAs(UnmanagedType.LPStr)] string val,
      double* double_out);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_eval_q(
      void* obj,
      AVOption* o,
      [MarshalAs(UnmanagedType.LPStr)] string val,
      AVRational* q_out);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOption* av_opt_find(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOption* av_opt_find2(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      [MarshalAs(UnmanagedType.LPStr)] string unit,
      int opt_flags,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVOption* av_opt_next(void* obj, AVOption* prev);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_opt_child_next(void* obj, void* prev);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClass* av_opt_child_class_next(
      AVClass* parent,
      AVClass* prev);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      [MarshalAs(UnmanagedType.LPStr)] string val,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_int(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      long val,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_double(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      double val,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_q(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      AVRational val,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_bin(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      sbyte* val,
      int size,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_image_size(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int w,
      int h,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_pixel_fmt(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      AVPixelFormat fmt,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_sample_fmt(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      AVSampleFormat fmt,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_video_rate(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      AVRational val,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_channel_layout(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      long ch_layout,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_set_dict_val(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      AVDictionary* val,
      int search_flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
      sbyte** out_val);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_int(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
      long* out_val);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_double(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
      double* out_val);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_q(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
      AVRational* out_val);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_image_size(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
      int* w_out,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_pixel_fmt(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_sample_fmt(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_video_rate(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
      AVRational* out_val);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_channel_layout(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
      long* ch_layout);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_get_dict_val(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* av_opt_ptr(AVClass* avclass, void* obj, [MarshalAs(UnmanagedType.LPStr)] string name);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_opt_freep_ranges(AVOptionRanges** ranges);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_query_ranges(
      AVOptionRanges** param0,
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string key,
      int flags);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_copy(void* dest, void* src);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_query_ranges_default(
      AVOptionRanges** param0,
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string key,
      int flags);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_is_set_to_default(void* obj, AVOption* o);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_is_set_to_default_by_name(
      void* obj,
      [MarshalAs(UnmanagedType.LPStr)] string name,
      int search_flags);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_opt_serialize(
      void* obj,
      int opt_flags,
      int flags,
      sbyte** buffer,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_read_image_line(
      ushort* dst,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] data,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_write_image_line(
      ushort* src,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] data,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] int[] linesize,
      AVPixFmtDescriptor* desc,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe sbyte* av_get_pix_fmt_string(
      IntPtr buf,
      int buf_size,
      AVPixelFormat pix_fmt);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_get_bits_per_pixel(AVPixFmtDescriptor* pixdesc);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_get_padded_bits_per_pixel(AVPixFmtDescriptor* pixdesc);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixFmtDescriptor* av_pix_fmt_desc_get(
      AVPixelFormat pix_fmt);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixFmtDescriptor* av_pix_fmt_desc_next(
      AVPixFmtDescriptor* prev);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixelFormat av_pix_fmt_desc_get_id(
      AVPixFmtDescriptor* desc);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_pix_fmt_get_chroma_sub_sample(
      AVPixelFormat pix_fmt,
      int* h_shift,
      int* v_shift);
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVPixelFormat av_find_best_pix_fmt_of_2(
      AVPixelFormat dst_pix_fmt1,
      AVPixelFormat dst_pix_fmt2,
      AVPixelFormat src_pix_fmt,
      int has_alpha,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_image_fill_max_pixsteps(
    ...
    public static extern int av_image_fill_linesizes(
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] int[] linesizes,
      AVPixelFormat pix_fmt,
      int width);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_image_fill_pointers(
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] data,
      AVPixelFormat pix_fmt,
      int height,
      sbyte* ptr,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_image_alloc(
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] pointers,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] int[] linesizes,
      int w,
      int h,
      AVPixelFormat pix_fmt,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_image_copy_plane(
      sbyte* dst,
      int dst_linesize,
      sbyte* src,
      int src_linesize,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void av_image_copy(
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] dst_data,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] int[] dst_linesizes,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] src_data,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] int[] src_linesizes,
      AVPixelFormat pix_fmt,
      int width,
      int height);

    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_image_fill_arrays(
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] dst_data,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_image_copy_to_buffer(
      sbyte* dst,
      int dst_size,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] sbyte*[] src_data,
    ...
    [DllImport("avutil-55", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int av_image_check_size(
      uint w,
      uint h,
      int log_offset,
      void* log_ctx);
    ...
    public static extern unsafe AVClass* swr_get_class();

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwrContext* swr_alloc();

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_init(SwrContext* s);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_is_initialized(SwrContext* s);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwrContext* swr_alloc_set_opts(
      SwrContext* s,
      long out_ch_layout,
    ...
    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void swr_free(SwrContext** s);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void swr_close(SwrContext* s);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_convert(
      SwrContext* s,
      sbyte** @out,
      int out_count,
      sbyte** @in,
    ...
    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long swr_next_pts(SwrContext* s, long pts);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_set_compensation(
      SwrContext* s,
      int sample_delta,
      int compensation_distance);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_set_channel_mapping(SwrContext* s, int* channel_map);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_set_matrix(SwrContext* s, double* matrix, int stride);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_drop_output(SwrContext* s, int count);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_inject_silence(SwrContext* s, int count);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe long swr_get_delay(SwrContext* s, long @base);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_get_out_samples(SwrContext* s, int in_samples);
    ...
    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_convert_frame(
      SwrContext* swr,
      AVFrame* output,
      AVFrame* input);

    [DllImport("swresample-2", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int swr_config_frame(SwrContext* swr, AVFrame* @out, AVFrame* @in);
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int* sws_getCoefficients(int colorspace);
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsContext* sws_alloc_context();

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int sws_init_context(
      SwsContext* sws_context,
      SwsFilter* srcFilter,
      SwsFilter* dstFilter);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_freeContext(SwsContext* swsContext);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsContext* sws_getContext(
      int srcW,
      int srcH,
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int sws_setColorspaceDetails(
      SwsContext* c,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] int[] inv_table,
      int srcRange,
      [MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] int[] table,
      int dstRange,
      int brightness,
      int contrast,
      int saturation);
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe int sws_getColorspaceDetails(
      SwsContext* c,
      int** inv_table,
      int* srcRange,
      int** table,
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsVector* sws_allocVec(int length);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsVector* sws_getGaussianVec(
      double variance,
      double quality);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsVector* sws_getConstVec(double c, int length);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsVector* sws_getIdentityVec();

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_scaleVec(SwsVector* a, double scalar);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_normalizeVec(SwsVector* a, double height);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_convVec(SwsVector* a, SwsVector* b);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_addVec(SwsVector* a, SwsVector* b);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_subVec(SwsVector* a, SwsVector* b);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_shiftVec(SwsVector* a, int shift);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsVector* sws_cloneVec(SwsVector* a);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_printVec2(SwsVector* a, AVClass* log_ctx, int log_level);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_freeVec(SwsVector* a);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsFilter* sws_getDefaultFilter(
      float lumaGBlur,
      float chromaGBlur,
      float lumaSharpen,
      float chromaSharpen,
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_freeFilter(SwsFilter* filter);

    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe SwsContext* sws_getCachedContext(
      SwsContext* context,
      int srcW,
      int srcH,
      AVPixelFormat srcFormat,
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_convertPalette8ToPacked32(
      sbyte* src,
      sbyte* dst,
      int num_pixels,
      sbyte* palette);
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void sws_convertPalette8ToPacked24(
      sbyte* src,
      sbyte* dst,
      int num_pixels,
      sbyte* palette);
    ...
    [DllImport("swscale-4", CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe AVClass* sws_get_class();
  }
}
